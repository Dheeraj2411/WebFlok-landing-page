export const siteConfig = {
  contact: {
    ...
    phoneFormatted:
      process.env.NEXT_PUBLIC_CONTACT_PHONE_FORMATTED || "+91 81787 81756",
  },
  social: {
    instagramId: process.env.NEXT_PUBLIC_INSTAGRAM_ID || "@WebFlok.Agency",
    instagramUrl:
      process.env.NEXT_PUBLIC_INSTAGRAM_URL ||
      "https://instagram.com/webflok.agency",
    facebookUrl:
      process.env.NEXT_PUBLIC_FACEBOOK_URL || "https://facebook.com/webflok",
    linkedinUrl:
      process.env.NEXT_PUBLIC_LINKEDIN_URL ||
      "https://linkedin.com/company/webflok",
