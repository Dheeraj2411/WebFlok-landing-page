            ...
            >
              ...
              <div className="p-8 md:p-10">
                <div className="flex justify-between items-start mb-8">
                  <div>
                    <h2 className="font-headline text-2xl md:text-3xl font-black text-primary uppercase tracking-tight leading-none text-balance">Book a <br />Strategy Call</h2>
                    <p className="text-on-surface-variant text-sm mt-2 font-medium opacity-80">Let's discuss how we can scale your brand.</p>
                  </div>
                  <button 
                    onClick={onClose}
                    className="w-12 h-12 flex items-center justify-center rounded-full hover:bg-surface-container transition-colors flex-shrink-0"
                  >
                ...
                <form className="space-y-5" onSubmit={(e) => e.preventDefault()}>
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-primary uppercase tracking-[0.3em] ml-1">Full Name</label>
                    <input 
                      type="text" 
                      placeholder="John Doe"
                      className="w-full px-5 py-4 bg-surface-container rounded-2xl border border-outline-variant focus:border-primary focus:outline-none transition-all font-bold text-sm shadow-inner"
                    />
                  </div>
                  
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-primary uppercase tracking-[0.3em] ml-1">Email Address</label>
                    <input 
                      type="email" 
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-primary uppercase tracking-[0.3em] ml-1">Phone Number</label>
                    <input 
                      type="tel" 
                  ...
                  <div className="space-y-1.5">
                    <label className="text-[10px] font-black text-primary uppercase tracking-[0.3em] ml-1">Preferred Time</label>
                ...
                <div className="mt-10 pt-8 border-t border-outline-variant text-center">
                  <p className="text-[10px] font-black text-on-surface-variant uppercase tracking-[0.3em] mb-5 opacity-60">Or Instant Connect</p>
                  <a 
