...
export const SocialShowcase = () => {
  const handles = [
    { name: "@WebFlok.Agency", desc: "Our primary creative showcase", followers: "12K+" },
    { name: "@WebFlok_Media", desc: "Daily marketing tips & tricks", followers: "8K+" }
  ];
  ...
  return (
    <section className="py-20 md:py-32 bg-surface-container-low rounded-[48px] px-8 md:px-16 my-12 overflow-hidden scroll-mt-24">
      <div className="max-w-[1300px] mx-auto">
        <div className="flex flex-col lg:flex-row gap-20 items-center">
          <div className="lg:w-1/2 space-y-10">
            ...
            <h2 className="font-headline text-4xl md:text-7xl font-black text-primary leading-[1] text-balance tracking-tighter">
              End-to-End <br />
            ...
            <p className="text-base md:text-xl text-on-surface-variant leading-relaxed font-medium opacity-90 text-balance tracking-tight">
              We don't just post; we create experiences. From professional photography and reel production to daily management and audience engagement, we handle everything.
            </p>
              ...
              {handles.map((handle, i) => (
                ...
                >
                  <div className="flex items-center gap-4">
                    <div className="w-12 h-12 rounded-full bg-gradient-to-tr from-[#FFD600] via-[#E1306C] to-[#5851DB] flex items-center justify-center text-white">
                      <span className="material-symbols-outlined">camera</span>
                    </div>
                    <div>
                      <h4 className="font-bold text-primary">{handle.name}</h4>
                      <p className="text-xs text-on-surface-variant">{handle.desc}</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-black text-primary">{handle.followers}</p>
                    <p className="text-[10px] font-bold text-[#E1306C] uppercase tracking-widest">Followers</p>
                  </div>
                </motion.div>
              ))}
            </div>
