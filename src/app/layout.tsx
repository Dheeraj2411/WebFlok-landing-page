...
export const metadata: Metadata = {
  ...
  description:
    "WebFlok helps startups and local businesses scale with premium web design, SEO, and strategic Social Media Marketing. Get a fast, high-converting website today.",
  keywords: [
  ...
  openGraph: {
    ...
    description:
      "Scale your startup with India's most modern web and marketing agency.",
    url: siteConfig.url,
    siteName: "WebFlok",
    images: [
      {
    ...
    >
      <head>
        <meta
          ...
          content="p8f6n64x9xsfll1jggioya5czzhz69"
        />
      ...
      <body
        className={`${plusJakartaSans.variable} min-h-full flex flex-col font-body bg-background text-on-surface`}
      >
        {children}
        <CookieConsent />
      </body>
